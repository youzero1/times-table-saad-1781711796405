    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-red-100 flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-md p-4 mb-6 flex items-center gap-4">
          <label className="text-sm font-medium text-red-600 whitespace-nowrap">
            Show up to:
          </label>
          <input
            type="range"
          ...
          />
          <span className="text-red-600 font-bold text-lg w-8 text-center">
            {maxValue}
          </span>
        </div>
              ...
              >
                <span
                  className={clsx(
                    ...
                    highlightedRow === n ? 'text-red-700' : 'text-gray-700'
                  )}
                >
                  {MULTIPLIER} &times; {n}
                </span>
                <span
                  className={clsx(
                    'text-base font-bold',
                    highlightedRow === n ? 'text-red-600' : 'text-gray-800'
                  )}
                >
                  = {MULTIPLIER * n}
                </span>
