    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-md p-4 mb-6 flex items-center gap-4">
          ...
          />
          <span className="text-indigo-600 font-bold text-lg w-8 text-center">
            {maxValue}
          </span>
        </div>
              ...
              >
                <span
                  className={clsx(
                    ...
                    highlightedRow === n ? 'text-indigo-700' : 'text-gray-700'
                  )}
                >
                  {MULTIPLIER} &times; {n}
                </span>
                <span
                  className={clsx(
                    'text-base font-bold',
                    highlightedRow === n ? 'text-indigo-600' : 'text-gray-800'
                  )}
                >
                  = {MULTIPLIER * n}
                </span>
